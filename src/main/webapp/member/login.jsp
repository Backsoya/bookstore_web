	...
	<form action="" method="post">
		...
		<div class="box-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="userid" id="userid" size="22" class="form-control" maxlength='20' placeholder="아이디 입력" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="password" name="pwd" id="pwd" size="22" class="form-control" maxlength='20' placeholder="패스워드 입력" required>
				</div>
			</div>
