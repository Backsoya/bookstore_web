			...
			<form action="bEdit" method="post" enctype="multipart/form-data" id="uploadForm" name="uploadForm">
					...
					<tr>
						...
						<td class="disp">
							<c:if test="${vo.saveFilename!=null}">
								<img src="imgDown?upload=${vo.savePath}&saveFname=${vo.saveFilename}&originFname=${vo.srcFilename}"
									alt="" height="300px">
							</c:if>
						</td>
				...
				<div class="btn_rud">
					<button type="button" id="btnList"
						onclick="location.href='bList?page=${page}&searchword=${searchword}&searchtype=${searchtype}'"
