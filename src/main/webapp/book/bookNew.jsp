...
<main>
	...
	<form action="bNew" method="post" id="uploadForm" enctype="multipart/form-data">
		<table class="table table-sm table-bordered">
			...
			<tr>
				<th>가격</th>
				<td><input type="text" size="120" maxlength="7" name="price" id="price" onkeydown="inputNum(this)" placeholder="가격입력" required></td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="file" name="file" id="file"> <small class="text-muted">(파일크기 : 2MB / 이미지 파일만 가능)</small> <small id="file" class="text-info"></small>
						</div>
					</div>
				</td>
			</tr>
